...
from engstats.plots.distributions import plot_histogram, plot_kde, plot_boxplot, plot_violin, plot_ecdf
...
from engstats.plots.probability import plot_normal_curve, plot_binomial_pmf, plot_confidence_interval
